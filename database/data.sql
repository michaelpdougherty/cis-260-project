...
/* Create patient rows */
insert into patients (`firstName`, `lastName`, `diagnosis`, `gender`, `dob`, `language`, `ethnicity`, `contact_info`, `admit_date`, `provider`, `hospital`, `comment`, `height`, `weight`, `image`) values ('Beatrice', 'Dolton', 'Arthritis', 'F', '1990-01-01', @language, @ethnicity, @contact_info, @admit_date, @provider, @hospital, @comments, 65, 130, @female_image);
set @beatrice_dolton_mrn = LAST_INSERT_ID();
insert into patients (`firstName`, `lastName`, `diagnosis`, `gender`, `dob`, `language`, `ethnicity`, `contact_info`, `admit_date`, `provider`, `hospital`, `comment`, `height`, `weight`, `image`) values ('Homer', 'Xiang', "Asperger's Syndrome", 'M', '1967-06-02', @language, @ethnicity, @contact_info, @admit_date, @provider, @hospital, @comments, 65, 130, @male_image);
insert into patients (`firstName`, `lastName`, `diagnosis`, `gender`, `dob`, `language`, `ethnicity`, `contact_info`, `admit_date`, `provider`, `hospital`, `comment`, `height`, `weight`, `image`) values ('Meredith', 'Dewietz', 'Carpal Tunnel Syndrome', 'F', '1984-02-21', @language, @ethnicity, @contact_info, @admit_date, @provider, @hospital, @comments, 68, 200, @female_image_2);
insert into patients (`firstName`, `lastName`, `diagnosis`, `gender`, `dob`, `language`, `ethnicity`, `contact_info`, `admit_date`, `provider`, `hospital`, `comment`, `height`, `weight`, `image`) values ('Suzanne', 'Rose', 'Anxiety', 'F', '1982-08-20', @language, @ethnicity, @contact_info, @admit_date, @provider, @hospital, @comments, 60, 130, @female_image_3);
insert into patients (`firstName`, `lastName`, `diagnosis`, `gender`, `dob`, `language`, `ethnicity`, `contact_info`, `admit_date`, `provider`, `hospital`, `comment`, `height`, `weight`, `image`) values ('William', 'Overath', 'Depression', 'M', '1991-11-01', @language, @ethnicity, @contact_info, @admit_date, @provider, @hospital, @comments, 67, 130, @male_image_2);
